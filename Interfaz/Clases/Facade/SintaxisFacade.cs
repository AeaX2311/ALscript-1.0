...
namespace Interfaz.Clases.Facade {
    class SintaxisFacade {
        ...
        private List<Gramatica> generarGramatica() {
            ...
            gramaticaAux.Add(new Gramatica("CE9", new List<string> { "CE9" }, true));
            ...
            gramaticaAux.Add(new Gramatica("INP5_2", new List<string> { "PRI2", "CE6", "INCOND", "CE7"}, true));
            ...
            gramaticaAux.Add(new Gramatica("VAL-1", new List<string> { "CE6", "VAL-1", "CE7" }, true));
            ...
            gramaticaAux.Add(new Gramatica("INR_2", new List<string> { "CE6", "VAL-2", "VAL-OPRA", "VAL-CONST" , "CE7" }, true));
            gramaticaAux.Add(new Gramatica("INR_3", new List<string> { "CE6", "VAL-CONST", "VAL-OPRA", "VAL-2", "CE7" }, true));
        ...
        private List<Gramatica> generarGramaticaAuxiliarVariable() {
            ...
            gramaticaAux.Add(new Gramatica("VAL-1", new List<string> { "CONSTENT" }, false));
            ...
            gramaticaAux.Add(new Gramatica("VAL-4", new List<string> { "VAL-CONST" }, false));
            ...
            gramaticaAux.Add(new Gramatica("VAL-4", new List<string> { "CADENA" }, false));
            ...
            gramaticaAux.Add(new Gramatica("VAL-CONDIC", new List<string> { "INO%" }, false));
            ...
            gramaticaAux.Add(new Gramatica("VAL-5", new List<string> { "VAL-4" }, false));
