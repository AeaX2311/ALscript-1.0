...
const gramaticasIf = {
  CON: [
    ...
    "IN_SI CON IN_SINOSI CON IN_PARFIN",
    "IN_SI IN_SINOSI CON IN_PARFIN",
    "IN_SI CON IN_SINOSI IN_PARFIN",
    "IN_SI IN_SINOSI IN_PARFIN",  

    "IN_SI CON IN_SINO CON IN_PARFIN",
    "IN_SI IN_SINO CON IN_PARFIN",
    "IN_SI IN_SINO IN_PARFIN",
    "IN_SI CON IN_SINO IN_PARFIN",
    
    "IN_SI CON IN_SINOSI CON IN_SINO CON IN_PARFIN",
    "IN_SI IN_SINOSI IN_SINO CON IN_PARFIN",
    "IN_SI IN_SINOSI CON IN_SINO CON IN_PARFIN",
    "IN_SI IN_SINOSI CON IN_SINO IN_PARFIN",
    "IN_SI CON IN_SINOSI CON IN_SINO IN_PARFIN",
    "IN_SI CON IN_SINOSI IN_SINO CON IN_PARFIN",
    "IN_SI CON IN_SINOSI IN_SINO IN_PARFIN",
    "IN_SI IN_SINOSI IN_SINO IN_PARFIN",
    
    
    "IN_CICLO CON IN_PARFIN",
    
    "IN_HACER CON IN_DO_MIENTRAS",

    "IN_MIENTRAS CON IN_PARFIN"
  ],
  
  IN_SINOSI:[
    "IN_SINOSI CON IN_SINOSI",
    "IN_SINOSI IN_SINOSI"
  ],
...
VAL_BOLEANO: [
    ...
    "VAL_BOLEANO OPL3 OP_RELACIONAL",
    "VAL_BOLEANO OPL2 OP_RELACIONAL",
    ...
    "OP_RELACIONAL OPL2 VAL_BOLEANO",
    "OP_RELACIONAL OPL3 VAL_BOLEANO",
